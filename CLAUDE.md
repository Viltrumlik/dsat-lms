...
> **Status:** plan LOCKED. **MVP COMPLETE (S0–S4) + S3 & S5 fast-follows shipped** (branch `feat/phase4-teacher-crm`). **S0**: `apps/support`
...
> attendance. All verified end-to-end in the browser + Playwright e2e. **MVP done (S0–S4); S3+S5 fast-follows
> shipped; remaining: S6 (Mentor), S7 (Admin ops).** Full design doc lived in a session scratchpad; this section
