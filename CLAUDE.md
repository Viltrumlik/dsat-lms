...
> `/teacher/mentees` surface + admin assign-by-email. All verified end-to-end in the browser (EN+UZ) + Playwright
> e2e. **MVP done (S0–S4); S3+S5+S6 shipped; remaining: S7 (Admin ops).** Full design doc lived in a session
